...
<a href="{FILEROOT}/publisher.php/{PID}">back to {PUBLISHER}</a>
</td>
</tr>
</table>
...
<a href="{FILEROOT}/pubcomments.php/{PID}/{START}">previous page</a>
<!-- END BLOCK : prevpage -->
<!-- START BLOCK : nextpage -->
<a href="{FILEROOT}/pubcomments.php/{PID}/{START}">next page</a>
<!-- END BLOCK : nextpage -->
<br />
